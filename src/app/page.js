      ...
      <div className="w-5/6 flex xl:flex-row flex-col h-auto justify-center items-center pb-20">
        ...
        <div className="flex flex-col mx-auto">
          ...
          <div className="flex flex-col lg:w-[600px] w-auto justify-center pb-8">
            <span className="mb-4 w-full text-[#324A6D]">Odwiedziłem niedawno tę restaurację i muszę przyznać, że było to niesamowite doświadczenie kulinarne! Obsługa była niezwykle uprzejma i profesjonalna, sprawiając, że czuliśmy się naprawdę mile widziani. Menu było bogate i zróżnicowane, co pozwoliło nam znaleźć coś dla siebie.</span>
            <div className="flex flex-row items-center">
              <img className="w-8 h-8" src="img/home-avatar.png" />
              <span className="font-bold text-sm ml-2">Jan Kowalski</span>
            </div>
          </div>
          <div className="flex flex-col lg:w-[600px] w-auto justify-center pb-8">
            <span className="mb-4 w-full text-[#324A6D]">Odwiedziłam niedawno tę restaurację i muszę przyznać, że było to niesamowite doświadczenie kulinarne! Obsługa była niezwykle uprzejma i profesjonalna, sprawiając, że czuliśmy się naprawdę mile widziani. Menu było bogate i zróżnicowane, co pozwoliło nam znaleźć coś dla siebie.</span>
            <div className="flex flex-row items-center">
              <img className="w-8 h-8" src="img/home-avatar.png" />
              <span className="font-bold text-sm ml-2">Anna Nowak</span>
            </div>
          </div>
        </div>
      </div>
